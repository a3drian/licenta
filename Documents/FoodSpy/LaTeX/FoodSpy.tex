...
\begin{document}
	...
	\chapter{Introducere}
	\input{Chapters/02_Introducere}
	
	\chapter{Aplicații web - noțiuni teoretice}
	\input{Chapters/03_Teorie}
	
	%\chapter{Limbaje de programare}
	%\input{Chapters/04_Limbaje}
	%
	%\chapter{Framework-uri web}
	%\input{Chapters/05_Framework-uri_web}
	%
	%\chapter{Tehnologii}
	%\input{Chapters/06_Tehnologii}
	%
	%\chapter{Descrierea aplicației}
	%\input{Chapters/07_Descrierea}
	%
	%\chapter{Utilizarea aplicației}
	%\input{Chapters/08_Utilizarea}
	%
	%\chapter{Concluzii și perspective de dezvoltare}
	%\input{Chapters/09_Concluzii}
	
	%\chapter{Bibliografie}
	%\input{Chapters/10_Bibliografie}
